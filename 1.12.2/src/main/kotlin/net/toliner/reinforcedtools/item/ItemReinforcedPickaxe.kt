 ...
 * @author kojin15.
 */
class ItemReinforcedPickaxe(material: Item.ToolMaterial) : ItemPickaxe(material), IReinforcedTool {
    init {
        unlocalizedName = "reinforced_${material.name.toLowerCase()}_pickaxe"
