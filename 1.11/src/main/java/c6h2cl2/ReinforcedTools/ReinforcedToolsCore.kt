...
@Mod(modid = ReinforcedToolsCore.Domain, version = ReinforcedToolsCore.Version, name = ReinforcedToolsCore.ModID, useMetadata = true, dependencies = "required-after:yukarilib@[1.1,)")
