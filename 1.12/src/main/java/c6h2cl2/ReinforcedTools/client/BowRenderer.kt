...
class BowRenderer : IItemRenderer {
    ...
    fun handleRenderType(item: ItemStack, type: IItemRenderer.ItemRenderType): Boolean {
    ...
    fun shouldUseRenderHelper(type: IItemRenderer.ItemRenderType, item: ItemStack, helper: IItemRenderer.ItemRendererHelper): Boolean {
        return false
    }
