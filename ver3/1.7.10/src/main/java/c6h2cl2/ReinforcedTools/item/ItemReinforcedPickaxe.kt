 ...
 * @author C6H2Cl2
 */
class ItemReinforcedPickaxe(material: ToolMaterial, private val level: Int) : ItemPickaxe(material), IReinforcedTools {
    ...
    init {
        ...
        setTextureName("${MOD_ID.toLowerCase()}.reinforced_${name.toLowerCase()}_pickaxe")
