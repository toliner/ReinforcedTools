 ...
 * @author C6H2Cl2
 */
class ItemReinforcedHoe(material: ToolMaterial, private val level: Int) : ItemHoe(material), IReinforcedTools {
    ...
    init {
        ...
        setTextureName("${MOD_ID.toLowerCase()}.reinforced_${name.toLowerCase()}_hoe")
