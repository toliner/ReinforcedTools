 ...
 * @author C6H2Cl2
 */
class ItemReinforcedSword(material: ToolMaterial, private val level: Int) : ItemSword(material), IReinforcedTools {
    ...
    init {
        ...
        setTextureName("${MOD_ID.toLowerCase()}.reinforced_${name.toLowerCase()}_sword")
